...
// Marca própria (skincare + linha de maquiagem própria) — testado com termo neutro
// ("hidratante") e termo de risco ("batom"), sem contaminação de categoria, então não
// precisa de filtro de categoria como as farmácias multimarca.
